...
- Automated test suite (`tests/`): 301 unit tests covering cache (incl. v1.2.1 concurrency regression), IOC detector, defang, knowledge base, timeline, config, async client, plugin dispatch, correlation, AbuseIPDB/Shodan enrichers, HTML export, and AI narratives — all deterministic, no network
